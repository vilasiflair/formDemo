    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $(".addQuestionRow").click(function(){
                ...
                var questionTypeValue = $('.questionTypeValue').val();
                /* if(questionTypeValue.length == 0){
                    $('.questionTypeValue').after('<div class="red">Address is Required</div>');
                    return false;
                }
                else {
                    $('.questionTypeValue').next('.red').remove();
                    return true;
                } */
                ...
                console.log("multiOptionsValueData", multiOptionsValueData);
